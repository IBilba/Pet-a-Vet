  ...
  describe("Login Page Integration", () => {
    ...
    describe("Failed Login Flow", () => {
      it("should handle user not found error", async () => {
        ...
        await waitFor(() => {
          expect(
            screen.getByText("No user with these login details.")
          ).toBeInTheDocument();
          expect(
            screen.getByText("Would you like to create a new account?")
          ).toBeInTheDocument();
        });
      });
  ...
  describe("Registration Page Integration", () => {
    describe("Successful Registration Flow", () => {
      it("should complete successful registration with all fields", async () => {
        ...
        await user.click(
          screen.getByRole("tab", { name: /contact information/i })
        );
    ...
    describe("Failed Registration Flow", () => {
      ...
      it("should validate Greek phone number format", async () => {
        ...
        await waitFor(() => {
          expect(
            screen.getByText(/please enter a valid greek phone number/i)
          ).toBeInTheDocument();
        });
      });
    });
    ...
    describe("Form Validation", () => {
      ...
      it("should highlight required fields when empty", async () => {
        ...
        // Assert
        await waitFor(() => {
          expect(screen.getByLabelText(/full name/i)).toHaveClass(
            "border-red-500"
          );
    ...
    describe("Tab Navigation", () => {
      it("should navigate between form tabs", async () => {
        ...
        // Act & Assert
        expect(
          screen.getByRole("tab", { name: /basic information/i })
