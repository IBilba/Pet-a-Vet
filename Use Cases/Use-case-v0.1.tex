...
\subsection{Σημεία επέκτασης}
\begin{itemize}
  \item Ενσωμάτωση νέων μονάδων διαχείρισης αποθήκης % chktex 19
  \item Προσθήκη προηγμένων αναλυτικών στοιχείων
  \item Διασύνδεση με εξωτερικά συστήματα προμηθευτών % chktex 19
  \item Επέκταση για διαχείριση πολλαπλών αποθηκών % chktex 19
\end{itemize}
...
\begin{itemize}
  ...
  \item Προσθήκη δυνατότητας σάρωσης προϊόντων για αυτόματη καταχώρηση % chktex 19
  \item Υποστήριξη για πολυγλωσσικές περιγραφές προϊόντων
  \item Διασύνδεση με ηλεκτρονικό κατάστημα για συγχρονισμό προϊόντων % chktex 19
\end{itemize}
...
\begin{itemize}
  ...
  \item Διασύνδεση με λογιστικό σύστημα για αυτόματη ενημέρωση αξίας αποθέματος % chktex 19
...
\begin{itemize}
  ...
  \item Προσθήκη συστήματος παρακολούθησης παράδοσης (tracking) % chktex 19
