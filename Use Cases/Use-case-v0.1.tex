...
\section{Σύνδεση Χρήστη} % chktex 19
...
\begin{enumerate}
  ...
  \item[6 ] Ακύρωση προσθήκης:
        \begin{enumerate}
          ...
          \item [3.6.4 ] Το σύστημα εμφανίζει μήνυμα επιβεβαίωσης και οδηγεί τον χρήστη στο βήμα 2 της βασικής ροής % chktex 19
        \end{enumerate}
...
\begin{enumerate}
  ...
  \item[3 ] Ακύρωση απογραφής:
        \begin{enumerate}
          \item [3.1 ] Ο χρήστης επιλέγει ακύρωση της απογραφής σε οποιοδήποτε σημείο % chktex 19
...
\begin{enumerate}
  ...
  \item[6 ] Ακύρωση διαδικασίας: % chktex 19
        \begin{enumerate}
          \item[6.1 ] Ο χρήστης επιλέγει την ακύρωση της διαδικασίας σε οποιοδήποτε σημείο % chktex 19
...
\begin{enumerate}
  ...
  \item[5 ] Ο πελάτης ακυρώνει το αίτημα πριν την έγκριση από την κλινική:
        \begin{enumerate}
          \item[7.5.1 ] Το σύστημα ακυρώνει το αίτημα και ειδοποιεί την κλινική. % chktex 19
          \item[7.5.2 ] Ο χρήστης  ανακατευθύνεται στην αρχική σελίδα. % chktex 19
        \end{enumerate}
...
\begin{itemize}
  ...
  \item Ο πελάτης επιλέγει το πλήκτρο για προβολή δεδομένων “Diagnosis, Treatment, Prescription” του ραντεβού % chktex 19
\end{itemize}
...
\subsubsection{Βασική Ροή}
\begin{enumerate}
  \item Ο χρήστης μπαίνει στην ενότητα “Diagnosis, Treatment, Prescription” του τρέχοντος ραντεβού  % chktex 19
...
\begin{enumerate}
  \item[1 ] Ακύρωση προσθήκης σε οποιοδήποτε βήμα:  % chktex 19
        \begin{enumerate}
          \item[1.1 ] Ο χρήστης επιλέγει ακύρωση εισαγωγής με back action  % chktex 19
          \item[1.2 ] Δε πραγματοποιείται καμία αποθήκευση. % chktex 19
          \item[1.3 ] Επιστρέφει στη σελίδα του ραντεβού  % chktex 19
        \end{enumerate}
...
\begin{enumerate}
  ...
  \item[2 ] Ακύρωση συνδρομής:   % chktex 19
        \begin{enumerate}
          \item[7.2.1 ] Ο χρήστης επιλέγει ακύρωση συνδρομής στο πλαίσιο της τρέχουσας συνδρομής  % chktex 19
          \item[7.2.2 ] Ο χρήστης πραγματοποιεί επιβεβαίωση % chktex 19
          \item[7.2.3 ] Το σύστημα εμφανίζει μήνυμα ενημέρωσης ακύρωσης συνδρομής  % chktex 19
          \item[7.2.4 ] Το σύστημα αποστέλλει email ενημέρωσης λεπτομερειών ακύρωσης συνδρομής  % chktex 19
          \item[7.2.5 ] Το σύστημα επιστρέφει στη σελίδα “Subscription”  % chktex 19
        \end{enumerate}
  \item[3 ] Ο χρήστης είναι πελάτης και έχει view only δικαιώματα:  % chktex 19
        \begin{enumerate}
          \item[2.3.1 ] Εμφανίζονται όλες οι σελίδες “Diagnosis, Treatment, Prescription” % chktex 19
...
\section{Δημιουργία Προφίλ Κατοικιδίου} % chktex 19
