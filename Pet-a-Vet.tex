...
Στην δεύτερη έκδοση, οι περιπτώσεις χρήσης και οι ροές τους είναι πιο αναλυτικές και περιλαμβάνουν περισσότερες λεπτομέρειες με βάση την ανάλυση ευρωστίας που πραγματοποιήθηκε. % chktex 19
...
Στη δεύτερη έκδοση του διαγράμματος, προστέθηκαν περισσότερες κλάσεις, σχέσεις και γνωρίσματα με βάση την ανάλυση ευρωστίας που πραγματοποιήθηκε. % chktex 19
